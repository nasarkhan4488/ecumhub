...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="./categories.html">search</a>
                        <span style="text-transform: capitalize;"><?php echo $_GET['search']?></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-6">
                                    <div class="section-title">
                                        <h4 id="categoryTitle"><?php echo $_GET['search'] ?></h4>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        function fetchGames(page = 1, orderBy = 'name ASC') {
            var category = "<?php echo $_GET['search']; ?>"; // Category from PHP
            $.ajax({
                url: "Source/ajax/fetch_search.php", // PHP file to fetch games
                method: "POST",
